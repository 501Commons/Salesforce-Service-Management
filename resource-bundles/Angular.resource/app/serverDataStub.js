...
angular.module('appServerData', [])
  .constant('basePath', '')
  .constant('controllerName', 'ServiceManagement');
...
var Visualforce = {
  remoting: {
    ...
    mockData: {
      ...
      'ServiceManagement.getCheckedInList': [
        { result: [{'checkinNotToday':true,'checkInTime':1394865903000,'clientId':'a00i000000DzX4eAAF','clientName':'Dave Boyce','pointsRemaining':72}] }
      ],
      'ServiceManagement.queryHouseholds': [
        { result: [{'addr':'3540 Quade Rd, Clinton, WA 98236','id':'a00i000000DzX4eAAF','name':'Dave Boyce','value':'Dave Boyce (3540 Quade Rd)'},{'addr':'Homeless, Langley, WA 98260','id':'a00i000000GOrlsAAD','name':'J J and B Daves','value':'J J and B Daves (Homeless)'},{'addr':'1334 Bercot Rd., Freeland, WA 98236','id':'a00i000000GOrjSAAT','name':'Jason, Jr and Dave Smith','value':'Jason, Jr and Dave Smith (1334 Plumcot Rd.)'}]  }
      ],
      'ServiceManagement.getHouseholdDetail': [
        { result: {'Client_Names__c':'Dave Boyce','Adults__c':1,'Notes__c':'Lorem ipsum dolor sit amet, consectetur elit, sed do sic eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','Full_Address__c':'3540 Quade Rd, Clinton, WA 98236','Total_Visits__c':6,'Postal_Code__c':'98236','LastModifiedDate':1394728892000,'Seniors__c':0,'Infants__c':1,'Phone__c':'(360) 555-1212','Name':'HH-000001','City__c':'Clinton','Monthly_Points_Available__c':80,'Inactive__c':false,'Address__c':'3540 Quade Rd','Proof_of_Address__c': 'ejc', 'Proof_of_Address_Date__c':moment().subtract(10,'days').valueOf(), 'Contacts':[{'Name':'Dave Boyce','FirstName':'Dave','LastName':'Boyce','Account':'a00i000000DzX4eAAF','Age_Group__c':'Adult','Age__c':48,'Id':'a02i000000A9AYPAA3','Birthdate':-123984000000},{'Name':'Baby Boyce','FirstName':'Baby','LastName':'Boyce','Account':'a00i000000DzX4eAAF','Age_Group__c':'Infant','Age__c':1,'Id':'a02i000000A9AYXAA3'}],'Children__c':0,'CreatedDate':1387437126000,'First_Visit__c':1326188100000,'State__c':'WA','Id':'a00i000000DzX4eAAF','Most_Recent_Visit__c':moment().subtract(8,'days').valueOf(),'Tags__c':'No Cook;Spanish'} }
      ],
      'ServiceManagement.checkIn': [ { result: { } } ],
      'ServiceManagement.cancelCheckIn': [ { result: { } } ],
      'ServiceManagement.saveHousehold': [
        { result: {'Client_Names__c':'Dave Boyce','Adults__c':1,'Notes__c':'Lorem ipsum dolor sit amet, consectetur elit, sed do sic eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','Full_Address__c':'3540 Quade Rd, Clinton, WA 98236','Total_Visits__c':6,'Postal_Code__c':'98236','LastModifiedDate':1394728892000,'Seniors__c':0,'Infants__c':1,'Phone__c':'(360) 555-1212','Name':'HH-000001','City__c':'Clinton','Monthly_Points_Available__c':80,'Inactive__c':false,'Address__c':'3540 Quade Rd','Proof_of_Address__c': 'ejc', 'Proof_of_Address_Date__c':moment().subtract(10,'days').valueOf(), 'Contacts':[{'Name':'Dave Boyce','FirstName':'Dave','LastName':'Boyce','Account':'a00i000000DzX4eAAF','Age_Group__c':'Adult','Age__c':48,'Id':'a02i000000A9AYPAA3','Birthdate':-123984000000},{'Name':'Baby Boyce','FirstName':'Baby','LastName':'Boyce','Account':'a00i000000DzX4eAAF','Age_Group__c':'Infant','Age__c':1,'Id':'a02i000000A9AYXAA3'}],'Children__c':0,'CreatedDate':1387437126000,'First_Visit__c':1326188100000,'State__c':'WA','Id':'a00i000000DzX4eAAF','Most_Recent_Visit__c':moment().subtract(8,'days').valueOf(),'Tags__c':'No Cook;Spanish'} }
      ],
      'ServiceManagement.saveHouseholdMembers': [
        { result: {'Client_Names__c':'Dave Boyce','Adults__c':1,'Notes__c':'Lorem ipsum dolor sit amet, consectetur elit, sed do sic eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','Full_Address__c':'3540 Quade Rd, Clinton, WA 98236','Total_Visits__c':6,'Postal_Code__c':'98236','LastModifiedDate':1394728892000,'Seniors__c':0,'Infants__c':1,'Phone__c':'(360) 555-1212','Name':'HH-000001','City__c':'Clinton','Monthly_Points_Available__c':80,'Inactive__c':false,'Address__c':'3540 Quade Rd','Proof_of_Address__c': 'ejc', 'Proof_of_Address_Date__c':moment().subtract(10,'days').valueOf(), 'Contacts':[{'Name':'Dave Boyce','FirstName':'Dave','LastName':'Boyce','Account':'a00i000000DzX4eAAF','Age_Group__c':'Adult','Age__c':48,'Id':'a02i000000A9AYPAA3','Birthdate':-123984000000},{'Name':'Baby Boyce','FirstName':'Baby','LastName':'Boyce','Account':'a00i000000DzX4eAAF','Age_Group__c':'Infant','Age__c':1,'Id':'a02i000000A9AYXAA3'}],'Children__c':0,'CreatedDate':1387437126000,'First_Visit__c':1326188100000,'State__c':'WA','Id':'a00i000000DzX4eAAF','Most_Recent_Visit__c':moment().subtract(8,'days').valueOf(),'Tags__c':'No Cook;Spanish'} }
      ],
      'ServiceManagement.saveHouseholdAndMembers': [ 
        { result: {'Client_Names__c':'Dave Boyce','Adults__c':1,'Notes__c':'Lorem ipsum dolor sit amet, consectetur elit, sed do sic eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','Full_Address__c':'3540 Quade Rd, Clinton, WA 98236','Total_Visits__c':6,'Postal_Code__c':'98236','LastModifiedDate':1394728892000,'Seniors__c':0,'Infants__c':1,'Phone__c':'(360) 555-1212','Name':'HH-000001','City__c':'Clinton','Monthly_Points_Available__c':80,'Inactive__c':false,'Address__c':'3540 Quade Rd','Proof_of_Address__c': 'ejc', 'Proof_of_Address_Date__c':moment().subtract(10,'days').valueOf(), 'Contacts':[{'Name':'Dave Boyce','FirstName':'Dave','LastName':'Boyce','Account':'a00i000000DzX4eAAF','Age_Group__c':'Adult','Age__c':48,'Id':'a02i000000A9AYPAA3','Birthdate':-123984000000},{'Name':'Baby Boyce','FirstName':'Baby','LastName':'Boyce','Account':'a00i000000DzX4eAAF','Age_Group__c':'Infant','Age__c':1,'Id':'a02i000000A9AYXAA3'}],'Children__c':0,'CreatedDate':1387437126000,'First_Visit__c':1326188100000,'State__c':'WA','Id':'a00i000000DzX4eAAF','Most_Recent_Visit__c':moment().subtract(8,'days').valueOf(),'Tags__c':'No Cook;Spanish'} }
      ],
      'ServiceManagement.logVisit':  [ { result: 'a01i000000Gqdt4AAB' } ],
      'ServiceManagement.getVisitHistory': [
